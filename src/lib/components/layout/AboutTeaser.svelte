...
<script lang="ts">
	...
	const teamMember: TeamMember = {
		name: "Alex Morgan",
		role: "Founder & CEO",
		image: "/generated/image-a-professional-founder-posing-for-a-head.webp"
	};
</script>
	...
	<div class="section-px section-py container mx-auto">
		<div class="relative mx-auto grid max-w-2xl place-items-center gap-16">
			<ScrollText
				...
				text={`"I once spent three hours hunting for the perfect gift across twenty-seven browser tabs. Found it, closed the wrong tab, lost it forever. That moment changed everything."`}
			/>
